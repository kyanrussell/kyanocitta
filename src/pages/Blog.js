...
function Blog() {
  return (
      <BlogPostContainer>
        ...
        <Body>
        On a May 11th pelagic trip with Peter Pyle and Anchor Charters out of Fort Bragg, we had the opportunity to observe
        ...
        the way to Mount Madonna. We probably cruised right past it!</Body>
      </BlogPostContainer>
  );
}
